...
<RDF:RDF xmlns:NC="http://home.netscape.com/NC-rdf#"
  ...
  <RDF:Description RDF:about="urn:root"
                   NC:ja-JP-mac_defaultHandlersVersion="4" />
  <RDF:Description RDF:about="urn:scheme:handler:mailto"
                   NC:useSystemDefault="true"
                   NC:alwaysAsk="false">
    <NC:possibleApplication RDF:resource="urn:handler:web:https://mail.google.com/mail/?extsrc=mailto&amp;url=%s"/>
    <NC:possibleApplication RDF:resource="urn:handler:web:http://compose.mail.yahoo.co.jp/ym/Compose?To=%s"/>
  </RDF:Description>
  ...
  <RDF:Description RDF:about="urn:handler:web:http://compose.mail.yahoo.co.jp/ym/Compose?To=%s"
                   NC:prettyName="Yahoo!メール"
                   NC:uriTemplate="http://compose.mail.yahoo.co.jp/ym/Compose?To=%s" />
