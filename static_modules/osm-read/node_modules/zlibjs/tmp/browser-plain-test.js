...
function inflateStreamTest(mode, testData, compressionType) {
  ...
  console.log("source head", testData.subarray(0, 10));
  // inflate
  var inflator = new Zlib.InflateStream();
  var inflate = new (USE_TYPEDARRAY ? Uint8Array : Array)(), buf, tmp;
  for (var i = 0, il = deflate.length; i < il; ++i) {
  ...
  console.log("inflate head", inflate.subarray(0, 10));
  console.log("inflated data size:", inflate.length)
