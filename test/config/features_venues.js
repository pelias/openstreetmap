...
var features = require('../../config/features_venues');

module.exports.tests = {};

// test exports
module.exports.tests.interface = function(test, common) {
  test('interface: features_venues', function(t) {
    t.true(Array.isArray(features), 'valid venues taglist');
    t.end();
  });
};
...
module.exports.all = function (tape, common) {
  ...
  function test(name, testFunction) {
    return tape('features_venues: ' + name, testFunction);
  }
